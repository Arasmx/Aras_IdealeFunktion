...
SUM(POWER((t.y1 - i.y1),2)) as "y1_y1",
SUM(POWER((t.y1 - i.y2),2)) as "y1_y2",
SUM(POWER((t.y1 - i.y3),2)) as "y1_y3",
SUM(POWER((t.y1 - i.y4),2)) as "y1_y4",
SUM(POWER((t.y1 - i.y5),2)) as "y1_y5",
SUM(POWER((t.y1 - i.y6),2)) as "y1_y6",
SUM(POWER((t.y1 - i.y7),2)) as "y1_y7",
SUM(POWER((t.y1 - i.y8),2)) as "y1_y8",
SUM(POWER((t.y1 - i.y9),2)) as "y1_y9",
SUM(POWER((t.y1 - i.y10),2)) as "y1_y10",
SUM(POWER((t.y1 - i.y11),2)) as "y1_y11",
SUM(POWER((t.y1 - i.y12),2)) as "y1_y12",
SUM(POWER((t.y1 - i.y13),2)) as "y1_y13",
SUM(POWER((t.y1 - i.y14),2)) as "y1_y14",
SUM(POWER((t.y1 - i.y15),2)) as "y1_y15",
SUM(POWER((t.y1 - i.y16),2)) as "y1_y16",
SUM(POWER((t.y1 - i.y17),2)) as "y1_y17",
SUM(POWER((t.y1 - i.y18),2)) as "y1_y18",
SUM(POWER((t.y1 - i.y19),2)) as "y1_y19",
SUM(POWER((t.y1 - i.y20),2)) as "y1_y20",
SUM(POWER((t.y1 - i.y21),2)) as "y1_y21",
SUM(POWER((t.y1 - i.y22),2)) as "y1_y22",
SUM(POWER((t.y1 - i.y23),2)) as "y1_y23",
SUM(POWER((t.y1 - i.y24),2)) as "y1_y24",
SUM(POWER((t.y1 - i.y25),2)) as "y1_y25",
SUM(POWER((t.y1 - i.y26),2)) as "y1_y26",
SUM(POWER((t.y1 - i.y27),2)) as "y1_y27",
SUM(POWER((t.y1 - i.y28),2)) as "y1_y28",
SUM(POWER((t.y1 - i.y29),2)) as "y1_y29",
SUM(POWER((t.y1 - i.y30),2)) as "y1_y30",
SUM(POWER((t.y1 - i.y31),2)) as "y1_y31",
SUM(POWER((t.y1 - i.y32),2)) as "y1_y32",
SUM(POWER((t.y1 - i.y33),2)) as "y1_y33",
SUM(POWER((t.y1 - i.y34),2)) as "y1_y34",
SUM(POWER((t.y1 - i.y35),2)) as "y1_y35",
SUM(POWER((t.y1 - i.y36),2)) as "y1_y36",
SUM(POWER((t.y1 - i.y37),2)) as "y1_y37",
SUM(POWER((t.y1 - i.y38),2)) as "y1_y38",
SUM(POWER((t.y1 - i.y39),2)) as "y1_y39",
SUM(POWER((t.y1 - i.y40),2)) as "y1_y40",
SUM(POWER((t.y1 - i.y41),2)) as "y1_y41",
SUM(POWER((t.y1 - i.y42),2)) as "y1_y42",
SUM(POWER((t.y1 - i.y43),2)) as "y1_y43",
SUM(POWER((t.y1 - i.y44),2)) as "y1_y44",
SUM(POWER((t.y1 - i.y45),2)) as "y1_y45",
SUM(POWER((t.y1 - i.y46),2)) as "y1_y46",
SUM(POWER((t.y1 - i.y47),2)) as "y1_y47",
SUM(POWER((t.y1 - i.y48),2)) as "y1_y48",
SUM(POWER((t.y1 - i.y49),2)) as "y1_y49",
SUM(POWER((t.y1 - i.y50),2)) as "y1_y50",
SUM(POWER((t.y2 - i.y1),2)) as "y2_y1",
SUM(POWER((t.y2 - i.y2),2)) as "y2_y2",
SUM(POWER((t.y2 - i.y3),2)) as "y2_y3",
SUM(POWER((t.y2 - i.y4),2)) as "y2_y4",
SUM(POWER((t.y2 - i.y5),2)) as "y2_y5",
SUM(POWER((t.y2 - i.y6),2)) as "y2_y6",
SUM(POWER((t.y2 - i.y7),2)) as "y2_y7",
SUM(POWER((t.y2 - i.y8),2)) as "y2_y8",
SUM(POWER((t.y2 - i.y9),2)) as "y2_y9",
SUM(POWER((t.y2 - i.y10),2)) as "y2_y10",
SUM(POWER((t.y2 - i.y11),2)) as "y2_y11",
SUM(POWER((t.y2 - i.y12),2)) as "y2_y12",
SUM(POWER((t.y2 - i.y13),2)) as "y2_y13",
SUM(POWER((t.y2 - i.y14),2)) as "y2_y14",
SUM(POWER((t.y2 - i.y15),2)) as "y2_y15",
SUM(POWER((t.y2 - i.y16),2)) as "y2_y16",
SUM(POWER((t.y2 - i.y17),2)) as "y2_y17",
SUM(POWER((t.y2 - i.y18),2)) as "y2_y18",
SUM(POWER((t.y2 - i.y19),2)) as "y2_y19",
SUM(POWER((t.y2 - i.y20),2)) as "y2_y20",
SUM(POWER((t.y2 - i.y21),2)) as "y2_y21",
SUM(POWER((t.y2 - i.y22),2)) as "y2_y22",
SUM(POWER((t.y2 - i.y23),2)) as "y2_y23",
SUM(POWER((t.y2 - i.y24),2)) as "y2_y24",
SUM(POWER((t.y2 - i.y25),2)) as "y2_y25",
SUM(POWER((t.y2 - i.y26),2)) as "y2_y26",
SUM(POWER((t.y2 - i.y27),2)) as "y2_y27",
SUM(POWER((t.y2 - i.y28),2)) as "y2_y28",
SUM(POWER((t.y2 - i.y29),2)) as "y2_y29",
SUM(POWER((t.y2 - i.y30),2)) as "y2_y30",
SUM(POWER((t.y2 - i.y31),2)) as "y2_y31",
SUM(POWER((t.y2 - i.y32),2)) as "y2_y32",
SUM(POWER((t.y2 - i.y33),2)) as "y2_y33",
SUM(POWER((t.y2 - i.y34),2)) as "y2_y34",
SUM(POWER((t.y2 - i.y35),2)) as "y2_y35",
SUM(POWER((t.y2 - i.y36),2)) as "y2_y36",
SUM(POWER((t.y2 - i.y37),2)) as "y2_y37",
SUM(POWER((t.y2 - i.y38),2)) as "y2_y38",
SUM(POWER((t.y2 - i.y39),2)) as "y2_y39",
SUM(POWER((t.y2 - i.y40),2)) as "y2_y40",
SUM(POWER((t.y2 - i.y41),2)) as "y2_y41",
SUM(POWER((t.y2 - i.y42),2)) as "y2_y42",
SUM(POWER((t.y2 - i.y43),2)) as "y2_y43",
SUM(POWER((t.y2 - i.y44),2)) as "y2_y44",
SUM(POWER((t.y2 - i.y45),2)) as "y2_y45",
SUM(POWER((t.y2 - i.y46),2)) as "y2_y46",
SUM(POWER((t.y2 - i.y47),2)) as "y2_y47",
SUM(POWER((t.y2 - i.y48),2)) as "y2_y48",
SUM(POWER((t.y2 - i.y49),2)) as "y2_y49",
SUM(POWER((t.y2 - i.y50),2)) as "y2_y50",
SUM(POWER((t.y3 - i.y1),2)) as "y3_y1",
SUM(POWER((t.y3 - i.y2),2)) as "y3_y2",
SUM(POWER((t.y3 - i.y3),2)) as "y3_y3",
SUM(POWER((t.y3 - i.y4),2)) as "y3_y4",
SUM(POWER((t.y3 - i.y5),2)) as "y3_y5",
SUM(POWER((t.y3 - i.y6),2)) as "y3_y6",
SUM(POWER((t.y3 - i.y7),2)) as "y3_y7",
SUM(POWER((t.y3 - i.y8),2)) as "y3_y8",
SUM(POWER((t.y3 - i.y9),2)) as "y3_y9",
SUM(POWER((t.y3 - i.y10),2)) as "y3_y10",
SUM(POWER((t.y3 - i.y11),2)) as "y3_y11",
SUM(POWER((t.y3 - i.y12),2)) as "y3_y12",
SUM(POWER((t.y3 - i.y13),2)) as "y3_y13",
SUM(POWER((t.y3 - i.y14),2)) as "y3_y14",
SUM(POWER((t.y3 - i.y15),2)) as "y3_y15",
SUM(POWER((t.y3 - i.y16),2)) as "y3_y16",
SUM(POWER((t.y3 - i.y17),2)) as "y3_y17",
SUM(POWER((t.y3 - i.y18),2)) as "y3_y18",
SUM(POWER((t.y3 - i.y19),2)) as "y3_y19",
SUM(POWER((t.y3 - i.y20),2)) as "y3_y20",
SUM(POWER((t.y3 - i.y21),2)) as "y3_y21",
SUM(POWER((t.y3 - i.y22),2)) as "y3_y22",
SUM(POWER((t.y3 - i.y23),2)) as "y3_y23",
SUM(POWER((t.y3 - i.y24),2)) as "y3_y24",
SUM(POWER((t.y3 - i.y25),2)) as "y3_y25",
SUM(POWER((t.y3 - i.y26),2)) as "y3_y26",
SUM(POWER((t.y3 - i.y27),2)) as "y3_y27",
SUM(POWER((t.y3 - i.y28),2)) as "y3_y28",
SUM(POWER((t.y3 - i.y29),2)) as "y3_y29",
SUM(POWER((t.y3 - i.y30),2)) as "y3_y30",
SUM(POWER((t.y3 - i.y31),2)) as "y3_y31",
SUM(POWER((t.y3 - i.y32),2)) as "y3_y32",
SUM(POWER((t.y3 - i.y33),2)) as "y3_y33",
SUM(POWER((t.y3 - i.y34),2)) as "y3_y34",
SUM(POWER((t.y3 - i.y35),2)) as "y3_y35",
SUM(POWER((t.y3 - i.y36),2)) as "y3_y36",
SUM(POWER((t.y3 - i.y37),2)) as "y3_y37",
SUM(POWER((t.y3 - i.y38),2)) as "y3_y38",
SUM(POWER((t.y3 - i.y39),2)) as "y3_y39",
SUM(POWER((t.y3 - i.y40),2)) as "y3_y40",
SUM(POWER((t.y3 - i.y41),2)) as "y3_y41",
SUM(POWER((t.y3 - i.y42),2)) as "y3_y42",
SUM(POWER((t.y3 - i.y43),2)) as "y3_y43",
SUM(POWER((t.y3 - i.y44),2)) as "y3_y44",
SUM(POWER((t.y3 - i.y45),2)) as "y3_y45",
SUM(POWER((t.y3 - i.y46),2)) as "y3_y46",
SUM(POWER((t.y3 - i.y47),2)) as "y3_y47",
SUM(POWER((t.y3 - i.y48),2)) as "y3_y48",
SUM(POWER((t.y3 - i.y49),2)) as "y3_y49",
SUM(POWER((t.y3 - i.y50),2)) as "y3_y50",
SUM(POWER((t.y4 - i.y1),2)) as "y4_y1",
SUM(POWER((t.y4 - i.y2),2)) as "y4_y2",
SUM(POWER((t.y4 - i.y3),2)) as "y4_y3",
SUM(POWER((t.y4 - i.y4),2)) as "y4_y4",
SUM(POWER((t.y4 - i.y5),2)) as "y4_y5",
SUM(POWER((t.y4 - i.y6),2)) as "y4_y6",
SUM(POWER((t.y4 - i.y7),2)) as "y4_y7",
SUM(POWER((t.y4 - i.y8),2)) as "y4_y8",
SUM(POWER((t.y4 - i.y9),2)) as "y4_y9",
SUM(POWER((t.y4 - i.y10),2)) as "y4_y10",
SUM(POWER((t.y4 - i.y11),2)) as "y4_y11",
SUM(POWER((t.y4 - i.y12),2)) as "y4_y12",
SUM(POWER((t.y4 - i.y13),2)) as "y4_y13",
SUM(POWER((t.y4 - i.y14),2)) as "y4_y14",
SUM(POWER((t.y4 - i.y15),2)) as "y4_y15",
SUM(POWER((t.y4 - i.y16),2)) as "y4_y16",
SUM(POWER((t.y4 - i.y17),2)) as "y4_y17",
SUM(POWER((t.y4 - i.y18),2)) as "y4_y18",
SUM(POWER((t.y4 - i.y19),2)) as "y4_y19",
SUM(POWER((t.y4 - i.y20),2)) as "y4_y20",
SUM(POWER((t.y4 - i.y21),2)) as "y4_y21",
SUM(POWER((t.y4 - i.y22),2)) as "y4_y22",
SUM(POWER((t.y4 - i.y23),2)) as "y4_y23",
SUM(POWER((t.y4 - i.y24),2)) as "y4_y24",
SUM(POWER((t.y4 - i.y25),2)) as "y4_y25",
SUM(POWER((t.y4 - i.y26),2)) as "y4_y26",
SUM(POWER((t.y4 - i.y27),2)) as "y4_y27",
SUM(POWER((t.y4 - i.y28),2)) as "y4_y28",
SUM(POWER((t.y4 - i.y29),2)) as "y4_y29",
SUM(POWER((t.y4 - i.y30),2)) as "y4_y30",
SUM(POWER((t.y4 - i.y31),2)) as "y4_y31",
SUM(POWER((t.y4 - i.y32),2)) as "y4_y32",
SUM(POWER((t.y4 - i.y33),2)) as "y4_y33",
SUM(POWER((t.y4 - i.y34),2)) as "y4_y34",
SUM(POWER((t.y4 - i.y35),2)) as "y4_y35",
SUM(POWER((t.y4 - i.y36),2)) as "y4_y36",
SUM(POWER((t.y4 - i.y37),2)) as "y4_y37",
SUM(POWER((t.y4 - i.y38),2)) as "y4_y38",
SUM(POWER((t.y4 - i.y39),2)) as "y4_y39",
SUM(POWER((t.y4 - i.y40),2)) as "y4_y40",
SUM(POWER((t.y4 - i.y41),2)) as "y4_y41",
SUM(POWER((t.y4 - i.y42),2)) as "y4_y42",
SUM(POWER((t.y4 - i.y43),2)) as "y4_y43",
SUM(POWER((t.y4 - i.y44),2)) as "y4_y44",
SUM(POWER((t.y4 - i.y45),2)) as "y4_y45",
SUM(POWER((t.y4 - i.y46),2)) as "y4_y46",
SUM(POWER((t.y4 - i.y47),2)) as "y4_y47",
SUM(POWER((t.y4 - i.y48),2)) as "y4_y48",
SUM(POWER((t.y4 - i.y49),2)) as "y4_y49",
SUM(POWER((t.y4 - i.y50),2)) as "y4_y50"
